/**
 * Creates PDCC role + database on an existing PostgreSQL server.
 * Use when Docker is unavailable and localhost:5432 is already your local Postgres.
 *
 *   set ADMIN_DATABASE_URL=postgresql://postgres:postgres@localhost:5432/postgres
